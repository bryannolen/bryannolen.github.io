...
let getStatus = () => {
    ...
    getJSON('https://game-status-api.ubisoft.com/v1/instances?appIds=6c6b8cd7-d901-4cd5-8279-07ba92088f06', (err, data) => {
        var date = new Date();
    ...
    Last Update: ${date}<br/>`
            ...
            if (data[0].Status == "Degraded") {
                infoDiv.style.backgroundColor="red"
            } else if (data[0].Status == "Online") {
